...
public class DropdownHandlerCategoryProject : MonoBehaviour
{
    ...
    private const string OtherTextKey = "OtherTextCategoryProject"; // Key to save/retrieve the input text
    ...
    public string GetOtherTextCategoryProject()
    {
        if (isOtherSelected)
        {
    ...
    public void SaveOtherTextCategoryProject()
    {
        if (isOtherSelected)
        {
    ...
    public string LoadOtherTextCategoryProject()
    {
        return PlayerPrefs.GetString(OtherTextKey, string.Empty);
    }

    public void SetOtherTextCategoryProject(string text)
    {
