...
public class DropdownHandlerCategoryBuisiness : MonoBehaviour
{
    ...
    private const string OtherTextKey = "OtherTextCategoryBuisiness"; // Key to save/retrieve the input text
    ...
    public string GetOtherTextCategoryBuisiness()
    {
        if (isOtherSelected)
        {
    ...
    public void SaveOtherTextCategoryBuisiness()
    {
        if (isOtherSelected)
        {
    ...
    public string LoadOtherTextCategoryBuisiness()
    {
        return PlayerPrefs.GetString(OtherTextKey, string.Empty);
    }

    public void SetOtherTextCategoryBuisiness(string text)
    {
