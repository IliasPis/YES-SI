...
public class DropdownHandlerBoyGoalProject : MonoBehaviour
{
    ...
    private const string OtherTextKey = "OtherTextBoyGoalProject"; // Key to save/retrieve the input text
    ...
    public string GetOtherTextBoyGoalProject()
    {
        if (isOtherSelected)
        {
    ...
    public void SaveOtherTextBoyGoalProject()
    {
        if (isOtherSelected)
        {
    ...
    public string LoadOtherTextBoyGoalProject()
    {
        return PlayerPrefs.GetString(OtherTextKey, string.Empty);
    }

    public void SetOtherTextBoyGoalProject(string text)
    {
